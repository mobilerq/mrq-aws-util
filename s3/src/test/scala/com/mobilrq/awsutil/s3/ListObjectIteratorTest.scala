...
class ListObjectIteratorTest {
  ...
  val requestCaptor: ArgumentCaptor[ListObjectsRequest] = ArgumentCaptor.forClass(classOf[ListObjectsRequest])
  val nextRequestCaptor: ArgumentCaptor[ListNextBatchOfObjectsRequest] = ArgumentCaptor.forClass(classOf[ListNextBatchOfObjectsRequest])
